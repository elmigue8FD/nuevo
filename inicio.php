              ...
              <div class="uk-grid">
                <div class="uk-width-1-1">
                  <ul class="uk-tab" data-uk-tab="{connect:'#tabs_1_content'}" id="tabs_1">
                    ...
                    <li class="named_tab" id="notif"><a href="" ><font size="3"> Notificaciones cuarta prueba hookles </font></a></li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div id="productoslinea">
              ...
              <div class="uk-modal" id="popup_nuevoproductolinea">
                <div class="uk-modal-dialog uk-modal-dialog-large">
                                ...
                                <li>
                                  <div class="uk-grid ">
                                    <div class="uk-width-large-1-1">
                                      ...
                                      <input type="text" name="alta_nombre_producto_linea" id="alta_nombre_producto_linea" class="md-input" />
                                    </div> 
                                  </div>
                                  <br/>
                                </li>
                                  ...
                                  <div class="uk-grid">
                                    ...
                                    <div class="uk-width-medium-1-1 ">
                                      <div class="uk-input-group">
                                        ...
                                        <div class="parsley-row">
                                          <h5 class="heading_c uk-margin-small-bottom">Categória</h5>
                                    ...
                                    <div class="uk-width-medium-1-1 ">
                                      <div class="uk-input-group">
                                        <span class="uk-input-group-addon"><i class="uk-icon-chevron-circle-right"></i></span>
                                        <div class="parsley-row">
                                          <h5 class="heading_c uk-margin-small-bottom">Clasificacíon</h5>
                  ...
                  <div class="uk-modal-footer uk-text-right">
                    <button type="button" class="md-btn md-btn-flat md-btn-flat-primary" onclick="UIkit.modal.confirm('Guardar y Registrar?', function(){ registrarProductoLinea(); UIkit.modal.alert('Producto Registrado'); });">Agregar Producto </button> 
                  </div>
                </div>  
              </div>
              <!--/////////////////////////////////// -->
